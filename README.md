...
A .Net Library that makes it simple to deploy plugins / workflows etc to Dynamics CRM without requiring any manual processes such as using the Plugin Registration Tool.

# Deploying a Plugin

CrmDeploy is available as a NuGet package: https://www.nuget.org/packages/CrmDeploy/ so it's reccomended that you use NuGet to add it to your solution.
